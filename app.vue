  ...
  <div class="w-full flex flex-col items-center relative">
    ...
    <div class="w-full max-w-screen-md absolute top-0 px-6 xl:px-0">
      <div class="mt-8 sm:mt-20 mb-10 flex flex-col sm:flex-row items-center justify-between">
        <NuxtLink to="/" class="text-white text-3xl md:text-4xl font-semibold inline-flex items-center text-shadow-md shadow-purple-500">
          <Logo class="mr-4"></Logo> Nexos Status
        </NuxtLink>
